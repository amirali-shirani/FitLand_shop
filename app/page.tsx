import {Banner, Bicycles, HeroSection, LatestShoes, Navbar, OfferSection, SpecialOffers} from "@/components";
import BannerHome from '@/public/assets/images/banner.png';
import BannerHome2 from '@/public/assets/images/banner2.jpg';
...
کنید و در سریع ترین زمان درب منزل تحویل بگیرید" link="/latest-products" data={offersData}/>
        <Banner title="برای حال خوب" subTitle="لوازم ایروبیک و تناسب اندام بگیر" image={BannerHome} link="/products"/>
        <SpecialOffers/>
        <LatestShoes/>

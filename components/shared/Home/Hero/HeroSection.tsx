                ...
                <div className="flex justify-between items-center gap-8">
                    <div className="lg:space-y-5 space-y-2 text-right ">
                        ...
                        <h1 className="text-secondary lg:text-3xl text-xl gap-2 flex flex-col font-semibold">
                            ...
                            <span className="text-primary lg:text-3xl text-xl text-nowrap">سهم بزرگ خودتان را امروز بگیرید!</span>
                        </h1>
                        <p className="text-custom-neutral lg:w-full w-11/12 my-7">
                    ...
                    <div className="z-20 order-none">
                        <Image src={ManHero} alt="man hero" className="wf z-20"/>
                    </div>
